...
- Native service/branch confirmation evidence checks `services.md`, `branches.md`, workspace service rows, source repository availability, target branch availability, and branch policy before worktree setup.
- Native worktree setup evidence checks missing workspace-local worktrees, target branch availability in source repositories, source repository availability, setup command visibility, and a service-level create/skip/blocked plan before development can continue.
