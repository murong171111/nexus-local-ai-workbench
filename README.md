...
- Native SwiftUI Task Center that surfaces open workspace tasks from `tasks.md`, including agent-sourced task writebacks and confirmed complete/defer actions.
