...
- Local automation checks for refresh, risk, delivery, target-branch availability, task, worktree, and dirty-service signals, exposed through Rust Core, the Swift/Rust bridge, the native menu bar, optional scheduled checks, visible local-check receipts, and configurable macOS notifications.
