...
- Native SwiftUI Automation Action Center that turns local check signals into risk focus, SQL-aware delivery handoff or delivery-document review, branch-document review, task focus, worktree setup review, dirty-service handoff, and Codex handoff prompts with the relevant task, delivery, risk, branch, worktree, or service workspace context.
