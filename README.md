...
- Native development-task evidence keeps root `tasks.md` as the execution source, chooses the next active task, blocks on unresolved task blockers, and opens the task source locator from the main workflow or Command Center.
