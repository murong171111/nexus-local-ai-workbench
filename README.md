...
- Native workspace Workflow now also shows a delivery-gate evidence card before the detailed checklist, so delivery blockers and the single next action are visible before scanning every row.
