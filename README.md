...
- Native worktree setup evidence checks missing workspace-local worktrees, branch mismatches, source repository availability, and setup command visibility before development can continue.
