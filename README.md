...
- Native SwiftUI Automation Action Center that turns local check signals into risk focus, SQL-aware delivery handoff or delivery-document review, task focus, worktree review, and Codex handoff prompts with the relevant workspace context.
