...
- Native SwiftUI shell now has two primary surfaces: `Console` for focused execution and `Board` for a stage-based overview of all filtered workspaces. Board columns follow the main requirement workflow and selecting a card returns to Console with that workspace focused.
