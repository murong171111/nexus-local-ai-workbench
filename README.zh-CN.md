...
Nexus 可以在 `~/Library/Application Support/com.ks.nexus/nexus-index.sqlite3` 重建本地 SQLite + FTS 索引。索引只是缓存，可以从可读的工作区文件重新生成；第一版索引标准工作区 Markdown 文件和 `sql/` 目录下的备注/SQL 文件。
