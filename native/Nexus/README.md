...
- Native local-write feedback after task and lifecycle writebacks, with affected-workspace focus, source-document review, and follow-up check actions.
...
- Native workspace detail starts with a Command Center for lifecycle progress, primary-path guidance, branch/service/risk/task signals, Codex continuation, local checks, next-step routing, and Finder/Terminal handoff.
