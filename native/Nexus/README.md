...
- Native workspace detail starts with a compact status overview for lifecycle, branch, services, risk, tasks, delivery, and latest local-check state before deeper sections.
