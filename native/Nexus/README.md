...
The Swift package includes a `NexusBridge` target with typed DTOs that match the Rust Core dashboard, source repository, document, and widget snapshot JSON contracts.
