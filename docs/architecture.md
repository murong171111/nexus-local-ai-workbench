...
8. The Tauri preview app shows grouped local index matches in the top search popover, supports keyboard navigation, and opens matched documents in the in-app viewer.
