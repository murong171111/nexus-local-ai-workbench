...
- Added native Automation Action Center branch routing so local checks emit target-branch availability signals, count branch issues, open the relevant `branches.md`, and copy branch-aware Codex prompts.
