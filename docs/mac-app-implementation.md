...
5. Expand native task actions into line-level document jumps, richer task filters, convert-to-Codex handoffs, and more audited event types for validation runs and PR handoff.
