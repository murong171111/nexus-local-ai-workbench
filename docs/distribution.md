...
- Open the built app and confirm:
  ...
  - Workspace detail shows the Workflow summary with task counts, delivery status, a delivery resolution plan, grouped document/check/Agent action lanes, delivery-readiness checks, inline local-check receipts, workspace Codex handoff, delivery-update Codex handoff, and validation/PR handoff.
