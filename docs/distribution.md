...
- Open the built app and confirm:
  ...
  - Native worktree setup refreshes the active workspace state and shows created/skipped/failed results with Finder, result-aware Codex, and local-check follow-ups, including an in-card local-check summary after checks run.
