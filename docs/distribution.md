...
- Open the built app and confirm:
  ...
  - Workflow delivery-readiness rows route branch, services/worktrees, tasks, risks, delivery records, SQL checks, and dirty services to the nearest document, setup flow, local check, or Codex handoff.
