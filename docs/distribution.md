...
- Open the built app and confirm:
  ...
  - Task status and lifecycle writebacks show a dismissible local-write feedback card with affected-workspace focus, source-document review, and follow-up check actions.
