...
- Open the built app and confirm:
  ...
  - Workspace detail starts with the Command Center and exposes lifecycle progress, primary-path guidance, branch/service/risk/task signals, a compact session path, Codex continuation, next-step routing, local check receipt, Finder, and Terminal.
