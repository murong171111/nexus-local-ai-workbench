...
- Automation Action Center delivery signals resolve a concrete target workspace before acting. SQL delivery issues are preferred over generic delivery-record issues, and copied automation prompts include the selected workspace's delivery record, SQL artifacts, and delivery/SQL check details.
