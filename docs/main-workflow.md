...
- Every stage has one primary action and one routed evidence source. `[started with WorkspaceStageAnswer primaryEvidenceLink and MainWorkflowAcceptanceEvidence action/evidence checks]`
