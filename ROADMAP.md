...
- Add safer worktree creation from selected source repositories. `[started in Rust Core, FFI, Tauri preview UI, and native SwiftUI with explicit confirmation, preflight review, refreshed state, result guidance, result-aware Codex handoff, and follow-up actions]`
