...
- Add saved filters and pinned workspaces. `[started in native SwiftUI shell with persisted search scope and pinned workspace preferences, plus browser-preview saved filters and workspace pins backed by localStorage and shared attention/filter sorting]`
