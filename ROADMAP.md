...
- Keep sample workspace data free of private local paths. `[done with publishable text scan in npm run privacy:check, including generated SwiftPM build-output exclusions]`
