...
- Add archived workspace filtering and keep archived contexts out of active risk/task/worktree attention signals. `[started in Rust Core, shared preview attention model, Tauri preview UI, and native SwiftUI shell]`
