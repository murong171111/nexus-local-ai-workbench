...
- Keep sample workspace data free of private local paths. `[done with publishable text scan in npm run privacy:check and dashboard sample shape checks in npm run sample:check]`
