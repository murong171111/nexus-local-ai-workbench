...
- Keep sample workspace data free of private local paths. `[done with publishable text scan in npm run privacy:check for app/web/native metadata assets and generated build-output exclusions]`
