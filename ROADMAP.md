...
- Improve error messages for missing directories, invalid paths, and git failures. `[started with native operation feedback, create/worktree preflight copy, settings profile import recovery context, and local dev-tool diagnostics including project-local Tauri CLI checks]`
